...
// let tba = "\\bTBA\\b|To Be Announced";

// let urlRoot = 'http://tvschedule.zap2it.com/tvlistings/';
// let tvgurlRoot = 'http://mobilelistings.tvguide.com/';
// let tvgMapiRoot = 'http://mapi.tvguide.com/';
// let tvgurl = 'http://www.tvguide.com/';
// let tvgspritesurl = 'http://static.tvgcdn.net/sprites/';
...
// let ncsCount = ncsdays * (24 / gridHours);
// let d = new Date();
// let ms = d.getTime() + offset;

// let i;
// let maxCount = days * (24 / gridHours);
// for (i = 0; i < maxCount; i++) {
//   if (i == 0) { 
//     let schedStartTime = ms;
//   } else if (i == maxCount - 1) {  
//     schedEndTime = ms + (gridHours * 3600000) - 1;
//   }

//   if (i >= ncCount || i < ncsCount) {
//     let params = "";
//     if (lineupId) params += "&lineupId=$zlineupId"
...
//   // res = "TEST API CALL SUCCESS!"
//   // outText = cmd.run('./mc2xml -c us -g 05482');
//   // console.log(cmd.run('./mc2xml -c us -g 05482'));
//   // outText = shell.exec('./mc2xml -c us -g 05482 -f');

//   // file = ('xmltv.xml')
//   fs.readFile('xmltv.xml', 'utf8', function (err, data) {
//       if (err) {
